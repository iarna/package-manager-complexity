...
<!--
image: logos for various package managers– cpan, pip, gems, etc, etc
notes: this is not exactly a new problem
-->
...
<!--
notes: before we talk about how npm works, we need to think about what they mean to us
-->
...
<!--
Versus what we get on disk? (tree, flat list)
-->
...
<!--
one thing w/ deps, no context
npm@3 breaks this mod, but we'll come back to that
-->
...
<!--
Look at your package, find its dependencies, fetch and install them…
-->
...
<!--
image: banyon tree
notes: we've always conceptualized our dependencies as big trees or directed graphs depending on the language. But…
-->
...
<!--
image: plain / field / savanna
notes: when we installed we'd get a field.
-->
...
<!--
chart: read deps for module, download and extract dep, repeat
-->
...
<!--
pic: /path/to/global/install/location in some package manager

notes: All modules are installed in one place.

pic: giant perl search path

notes: Or many one places.
-->
...
<!--
notes: The great step forward with npm was giving each dependency its own local copy of other dependencies.
-->
---
...
<!--
but it still operates conceptually the same...

it just makes a tree instead of a field
-->
